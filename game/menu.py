...
class Menu:
    ...
    def __init__(self):
        ...
        self.background = pygame.image.load(
            resource_path("assets/images/menu/menu_background.png")
        )
    ...
    def draw(self, screen):
        ...
        title = self.title_font.render("COIN HUNTER", True, GOLD)
        ...
        for index, option in enumerate(self.options):
            ...
            text_rect = text.get_rect(
                center=(SCREEN_WIDTH // 2, 300 + index * 70)
            )

            screen.blit(text, text_rect)
            self.option_rects.append(text_rect.copy())
        ...
        for index, text in enumerate(controls):
            ...
            render = controls_font.render(text, True, color)

            screen.blit(render, (40, 560 + index * 24))